function [file_name_save] = GEDI_matching_rh95(workdir,path_to_gedi_mat,gedi_int_flag)
...
if gedi_int_flag
    GEDI_full = griddata(lon_in, lat_in, RH100_in, LON_IN,LAT_IN,'natural');
    ...
    geotiffwrite('GEDI_rh95_full.tif',GEDI_full,R_new,'CoordRefSysCode', EPSG);
...
GEDI_coords = [N S W E]
hv_coh = gamma_valid;
file_name_save = 'LIDAR_SAR_rh95.mat';
